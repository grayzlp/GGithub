...
import static com.grayzlp.ggithub.util.AnimUtils.lerp;

/**
 * A password entry widget which animates switching between masked and visible text. Borrow from google code.
 */
